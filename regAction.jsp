...
<%
  ...
  //모든 입력사항을 다 입력한 경우 
               ...
               int result = assetDAO.write(new AssetDTO(0, asset_name, priority,
            		   account_manage, encryption,logging,external_connect,
            		   asset_type, inter_face,protocol,os_type,usages));
