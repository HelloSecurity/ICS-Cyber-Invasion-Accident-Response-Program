...
<!-- 제이쿼리 자바스크립트 추가하기 -->
   ...
   %>
	<nav class="navbar navbar-default">
		...
		<div class="collapse navbar-collapse"
			...
			<ul class="nav navbar-nav">
				...
				<li class="active"><a href="scenarioEva.jsp">시나리오 평가</a></li>
	...
	<div id="crud_button">
	<input type="button" style = "margin-right:10px" value="시나리오 평가 화면으로" class="btn btn-primary pull-left" onclick="javascript:location.href='scenario_eva.jsp'"/>
