...
<body>
   ...
   <section class="container">
      <div class="row">
         <table name="AssetTable" class="table table-striped"style="text-align: center; valign: middle;
         border: 1px solid #dddddd">
            <thead>
               ...
               <tr>
                  <th width=9% scope="row" id="asset_manage"
                  ...
                  <th width=10% scope="row" id="asset_manage"
                     style="background-color: #eeeeee; text-align: center;">외부매체<br>연결성</th>
            ...
            <tbody>
               ...
               <tr>
                  ...
                  <td>
                     <%
                        if (rs.getInt("external_connect") == 1) {
                                 out.println("O");
                              } else {
                                 out.println("-");
               ...
               <form action="./regAction.jsp" method="post">
                  ...
                  <div class="form-row">
                     <div class="form-group col-sm-12">
                        <label>자산 속성  </label> &nbsp;&nbsp;
                        <input type=checkbox id="account_manage"value="1" maxlength="50" name="account_manage">계정관리
                        <input type=checkbox id="encryption" value="1" maxlength="50" name="encryption">암호화ㅤ 
                           <input type=checkbox id="logging" value="1" maxlength="50" name="logging">로그기록ㅤ
                        <input type=checkbox id="external_connect" value="1" maxlength="50" name="external_connect">외부매체연결성
                     </div>
                  </div>
