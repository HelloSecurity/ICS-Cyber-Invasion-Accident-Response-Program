...
%>
 ...
 <!-- <li><a href="scenario.jsp">시나리오 리스트</a></li>-->
    ...
    <div id ="search" style="padding-bottom :15px; margin-right:430px;" align="right">
       <tr>  
        <td colspan="7"> <br/>
    ...
    <div class ="row">
         <table name="Scenario_Table" class="table table-striped" style="text-align:center; border:1px solid #dddddd">
        ...
        <td><a href="scenarioDetail.jsp?id=<%=scenarioItem.getId() %>" ><%=scenarioItem.getScenario_name() %></a></td>
      ...
      <div id="crud" style="padding:10px; float:right; margin-right:430px;" align="right" >
         <!-- <button class = "btn btn-primary pull-right" onclick="location.href='asset_eva_select.jsp';"  type="button">평가완료</button> -->
    <%
 for(int i=1; i<= 1; i++){


%>            <form method="post" action="./updAction.jsp" class="form-inline mt-3"  style="float:right;">       
